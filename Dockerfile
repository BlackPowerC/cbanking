...
ADD https://github.com/BlackPowerC/cbanking_rest_api/archive/v1.3.0.tar.gz .
...
WORKDIR /home/cbanking/cbanking_rest_api-1.3.0
...
RUN apt-get autoremove --purge libodb-dev g++ make gcc \
    ...
    libodb-mysql-dev -y
RUN rm *.tar.gz googletest-release-1.8.0 rapidjson-1.1.0 libsodium-1.0.16 cbanking_rest_api-1.3.0 pistache-1-28-04-18 curl-7.60.0 -dr
