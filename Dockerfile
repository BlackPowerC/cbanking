...
ADD https://github.com/BlackPowerC/futura-bank/archive/v1.3.2.tar.gz .
...
WORKDIR /home/cbanking/futura-bank-1.3.2
...
RUN apt-get autoremove --purge libodb-dev g++ make gcc \
    ...
    libodb-mysql-dev -y
RUN rm *.tar.gz googletest-release-1.8.0 rapidjson-1.1.0 libsodium-1.0.16 futura-bank-1.3.2 pistache-1-28-04-18 curl-7.60.0 -dr
