...
ADD https://github.com/BlackPowerC/cbanking_rest_api/archive/v1.0.4.tar.gz .
...
WORKDIR /home/cbanking/cbanking_rest_api-1.0.4
...
RUN rm *.tar.gz googletest-release-1.8.0 rapidjson-1.1.0 libsodium-1.0.16 cbanking_rest_api-1.0.4 pistache-1-28-04-18 -dr
