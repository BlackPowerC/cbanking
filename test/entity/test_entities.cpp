    ...
    try
    {
...

        {
            try
            {
                ...
                // Les employés
                Employee sam(0, "sam", "sam@toto.com") ;
                Employee edem(0, "edem-kouakou","dada@toto.com") ;
                sam.addGroup(group1) ;
                sam.addGroup(group2) ;
                ...
                // Les clients
                Customer jordy(0, "jordy", "jojo@gmail.com") ;
                Customer ablavi(0, "ablavi", "abla@gmail.com") ;
                Customer koffi(0, "koffi", "tintin@gmail.com") ;
                // Persistence
